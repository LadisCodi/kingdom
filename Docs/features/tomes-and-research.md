...
> [`07-research.md`](07-research.md) (the tree this
> replaces), [`10-heroes.md`](10-heroes.md) (becoming `stardust.md`, §2),
> [`09-relics.md`](09-relics.md) (what Stardust
> competes with), [`08-magic.md`](08-magic.md) (Mana),
> [`15-social.md`](15-social.md) (§7, the prize this unlocks),
> [`02-map-scopes.md`](02-map-scopes.md) (where the contested landmarks live).

## 0. Why, and the argument the repo already makes

`07-research.md` says the tree today is *"more a checklist than a
...
([`03-economy.md`](03-economy.md) §2) — a ratio of 1.83×, which means the
tree is not a sink, it is a formality.

The fix is not more nodes. And [`10-heroes.md`](10-heroes.md) already contains
...
`../README.md` says the fog has to pay back three ways — resources,
...
[`03-economy.md`](03-economy.md) §1 just closed, and the ad reward is priced
as *one pool ≈ one span of production*.

**Decided: a second trickle currency.** Mana stays what magic costs
([`09-relics.md`](09-relics.md) §3), the ad keeps its
...
([`02-map-scopes.md`](02-map-scopes.md) §3). And **§7's contested landmarks pay
...
([`09-relics.md`](09-relics.md) §8) and
...
Docs that describe the wrong currency until then: `10-heroes.md` (becomes
`stardust.md` — its §1 is already the definition of Stardust),
`../README.md`'s economy section, `03-economy.md`'s wallet
table, and `07-research.md`. The frozen Unity snapshot (`01`–`11`) is
...
`07-research.md` describes two kinds of node: technologies (Gold +
...
the direct answer to `../README.md`'s recorded complaint that the game
...
Contested world-map landmarks ([`02-map-scopes.md`](02-map-scopes.md)) that boost
...
The repo already made this exact decision. `14-monetization.md` §3b and `08-magic.md`
...
One job each, which is the rule `03-economy.md` fought to
establish. **Fragments are deleted**
([`09-relics.md`](09-relics.md) §8), so the row count
does not grow: ingredients take the tier gate and Stardust keeps the level.

And the plank does not grow either. `03-economy.md` cut eleven
...
`07-research.md`'s *"research is the earned half of both gates"* and
...
[`15-social.md`](15-social.md) rather than a neighbour of it.
...
7. Investing Knowledge in a guild structure — with `15-social.md`.
...
5. **Do plot expansions come from the tree or from the world map?**
   [`02-map-scopes.md`](02-map-scopes.md) §3.2 wants growth in authored increments and
