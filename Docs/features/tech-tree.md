...
> [`07-research.md`](07-research.md) (the menu, the slots,
> the tree fog), [`09-relics.md`](09-relics.md)
> (ingredients, which replaced Fragments),
> [`02-map-scopes.md`](02-map-scopes.md) (the bounded plot this assumes).

## The problem this solves

`07-research.md` says it plainly about its own tree: it is **a
...
This reverses `07-research.md`'s "research is the earned half of both
gates" and it does not break promise 3 of
[`../README.md`](../README.md), because **Gems are
...
| **Ley Lines** *(new)* | a district adjacent to the Sanctum produces +10% — **the first adjacency rule that is not Housing↔Housing, opening backlog gap 6.** [`02-map-scopes.md`](02-map-scopes.md) §1 is the precondition: adjacency cannot matter until the plot is bounded |
...
distortion `03-economy.md` pulled the Market beats back from. The onboarding
...
[`12-quests.md`](12-quests.md) describes the old ordering.
...
(clearing a defended landmark — `../README.md` open decision),
...
while `../README.md` says a new kingdom starts full at **50**.
...
what a spend costs. This edits [`08-magic.md`](08-magic.md), which
...
[`../README.md`](../README.md); this document does not keep
its own copy.
