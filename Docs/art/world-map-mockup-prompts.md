...
[`../features/19-world-map.md`](../features/19-world-map.md) §1–§3.
...
([`19-world-map.md`](../features/19-world-map.md) §3).
...
6. For the **place composition library** (`19-world-map.md` §1 — ~15–20
...
`19-world-map.md` §1.2, and the reason icons on the map can stay read-only.
